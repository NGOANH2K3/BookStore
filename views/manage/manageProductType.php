        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="mb-4 d-flex flex-row justify-content-between pt-3 pb-2 mb-3 border-bottom">
                    <a href="/createtype" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Thêm loại Sản Phẩm</a>
                ...
                <table id="all-products" class="table table-bordered table-responsive mb-5" style="border-color: #cacaca!important;">
                    ...
                    <tbody>
                        <?php foreach ($products_type as $productType_manage) : ?>
                            <tr style="font-size: 15px;">
                                <input class="" type="hidden" name="id" value="<?= $this->e($productType_manage->ma_loai_sach) ?>">
                                <td style="text-align: center; vertical-align: middle;"><?= $this->e($productType_manage->ma_loai_sach) ?></td>
                                <td style="text-align: center; vertical-align: middle;"><?= $this->e($productType_manage->ten_loai_sach) ?></td>
                                <td style="text-align: center; vertical-align: middle;"><a href="/manage/<?= $this->e($productType_manage->ma_loai_sach) ?>" class="btn btn-xs btn-warning" style="padding: 3px 6px;">
                                        <i alt="Edit" class="fa fa-edit"></i>
                                    </a>
                                </td>
                                <td style="text-align: center; vertical-align: middle;">
                                    <form class="delete" action="/manage/deletetype/<?= $this->e($productType_manage->ma_loai_sach) ?>" method="POST" style="display: inline;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Bạn muốn xóa loại sản phẩm <span class="product-info-delete fw-bold"></span> này không?
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('button.button-delete').on('click', function(e) {
                ...
                var ma_loai_sach = $(this).closest('tr').find('input[name=id]').val();
                var ten_loai_sach = $(this).closest('tr').find('td:eq(1)').text();

                if (ten_loai_sach.length > 0) {
                    $('.product-info-delete').html(ten_loai_sach + " (ID: " + ma_loai_sach + ") ");
                }
