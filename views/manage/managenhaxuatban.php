        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="mb-4 d-flex flex-row justify-content-between pt-3 pb-2 mb-3 border-bottom">
                    <a href="/createNXB" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Thêm nhà xuất bản</a>
                ...
                <table id="all-products" class="table table-bordered table-responsive mb-5" style="border-color: #cacaca!important;">
                    ...
                    <tbody>
                        <?php foreach ($nhaxuatban as $nhaxuatban_manage) : ?>
                            <tr style="font-size: 15px;">
                                <input class="" type="hidden" name="id" value="<?= $this->e($nhaxuatban_manage->ma_nxb) ?>">
                                <td style="text-align: center; vertical-align: middle;"><?= $this->e($nhaxuatban_manage->ma_nxb) ?></td>
                                <td style="text-align: center; vertical-align: middle;"><?= $this->e($nhaxuatban_manage->ten_nxb) ?></td>
                                <td style="text-align: center; vertical-align: middle;"><?= $this->e($nhaxuatban_manage->sdt_nxb) ?></td>
                                <td style="text-align: center; vertical-align: middle;"><?= $this->e($nhaxuatban_manage->dia_chi_nxb) ?></td>
                                <td style="text-align: center; vertical-align: middle;"><a href="/manage/<?= $this->e($nhaxuatban_manage->ma_nxb) ?>" class="btn btn-xs btn-warning" style="padding: 3px 6px;">
                                        <i alt="Edit" class="fa fa-edit"></i>
                                    </a>
                                </td>
                                <td style="text-align: center; vertical-align: middle;">
                                    <form class="delete" action="/manage/deleteNXB/<?= $this->e($nhaxuatban_manage->ma_nxb) ?>" method="POST" style="display: inline;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Bạn muốn xóa nhà xuất bản <span class="product-info-delete fw-bold"></span> này không?
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('button.button-delete').on('click', function(e) {
                ...
                var ma_nxb = $(this).closest('tr').find('input[name=id]').val();
                var ten_nxb = $(this).closest('tr').find('td:eq(1)').text();

                if (ten_nxb.length > 0) {
                    $('.product-info-delete').html(ten_nxb + " (ID: " + ma_nxb + ") ");
                }
