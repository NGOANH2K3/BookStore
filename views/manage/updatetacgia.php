        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="mb-4 d-flex flex-row justify-content-between pt-3 pb-2 mb-3 border-bottom">
                    <p class="fs-5 fw-bold">Cập Nhật tác giả</p>
                </div>
                <div class="inner-wrapper row">
                    <div class="col-md-12 d-flex justify-content-center">

                        <form name="frm" id="frm" action="/manage/updatetacgia/<?= $this->e($tacgia->ma_tac_gia) ?>" method="post" class="col-md-7 col-md-offset-3 p-5 mb-5 bg-body border border-2" enctype="multipart/form-data">

                            <!-- Name -->
                            <div class="form-group mb-3<?= isset($errors['ten_tac_gia']) ? ' has-error' : '' ?>">
                                <label class="fw-bold" for="name">Tên loại Sản Phẩm</label>
                                <input type="text" name="ten_tac_gia" class="form-control border border-1 border-secondary" maxlen="255" id="name" placeholder="Nhập tên" value="<?= isset($old_value['ten_tac_gia']) ? $this->e($old_value['ten_loai_sach']) : $this->e($tacgia->ten_tac_gia) ?>" style="background-color: #F3F6FF;" />
                            ...
                            <a href="/managetacgia" id="cancel-update" class="btn bg-secondary text-white fw-bold">Hủy</a>
                        </form>
